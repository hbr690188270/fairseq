...
def get_training_parser(default_task="speech_to_text2"):
...
def get_interactive_generation_parser(default_task="speech_to_text2"):
...
def add_model_args(parser):
    ...
    # group.add_argument(
    #     '--arch', '-a', default='ASRModel', metavar='ARCH', required=True,
